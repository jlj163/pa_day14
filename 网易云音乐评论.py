...
class music:
    ...
    def get_allcomments(self, url):
        ...
        f = open('comments/AllComments_shanqiu.txt', 'w', encoding='utf-8')
        present_page = 0
...
if __name__ == '__main__':
    music1 = music()
    music1.get_allcomments(url='https://music.163.com/weapi/v1/resource/comments/R_SO_4_407002091?csrf_token=')